...
export default function EditContact({ setShowEditContact, handleEditClick, contact }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  // Set form values when contact data is received
  React.useEffect(() => {
    if (contact) {
  ...
  const onSubmit = (data) => {
    handleEditClick(contact.id, data);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-purple-800 mb-6 text-center">Edit Contact</h2>
